    ...
    BootstrapDialog.show({  
         ...
         onshown : function () {  
            ...
            $('#tt_tree_services_popup').tree({
                url: 'https://proxy.b2argebilisim.com/SlimProxyBoot.php?url=pkFillNotInRestServicesOfPrivilegesTree_sysAclRrpRestservices&pk=' + $("#pk").val()+ '&language_code='+$("#langCode").val()+ '&rrp_id='+id,
                method: 'get',
                animate: true,
                checkbox: false,
                cascadeCheck: false,
