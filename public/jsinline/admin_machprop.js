...
BootstrapDialog.show({  
    ...
    onshown : function () {
       ...
       $('#tt_tree_menu_popup_clone').tree({  
            url: 'https://proxy.b2argebilisim.com/SlimProxyBoot.php?url=pkFillJustMachineToolGroupsNotInProperty_sysMachineToolGroups&pk=' + $("#pk").val()+ '&language_code='+$("#langCode").val()+ '&property_id='+nodeID,
            method: 'get',
            animate: true,
            checkbox: true,
            cascadeCheck: false,
 ...
 BootstrapDialog.show({  
     ...
     onshown : function () {
        ...
        $('#tt_tree_menu_popup').tree({
             url: 'https://proxy.b2argebilisim.com/SlimProxyBoot.php?url=pkFillUnitsTree_sysUnits&pk=' + $("#pk").val()+ '&language_code='+$("#langCode").val(),
             method: 'get',
             animate: true,
             checkbox: false,
             cascadeCheck: false,
