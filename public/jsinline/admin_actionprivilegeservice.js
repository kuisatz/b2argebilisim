...
*/
$('#tt_tree_menu2').tree({  
    url: 'https://proxy.b2argebilisim.com/SlimProxyBoot.php?url=pkFillActionResourceGroups_sysAclActionRrp&pk=' + $("#pk").val()+ '&language_code='+$("#langCode").val(),
    method: 'get',
    animate: true,
    checkbox: false,
    cascadeCheck: false,
    ...
    BootstrapDialog.show({  
         ...
         onshown : function () {  
            ...
            $('#tt_tree_services_popup').tree({
                url: 'https://proxy.b2argebilisim.com/SlimProxyBoot.php?url=pkFillNotInActionRestServicesOfPrivilegesTree_sysAclActionRrpRestservices&pk=' + $("#pk").val()+ '&language_code='+$("#langCode").val()+ '&rrp_id='+id,
                method: 'get',
                animate: true,
                checkbox: false,
                cascadeCheck: false,
