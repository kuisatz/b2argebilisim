...
//    console.log($('#pktemp').val());
    $('#table_address_modal').bootstrapTable({
        url: "https://proxy.b2argebilisim.com/SlimProxyBoot.php?url=pktempFillGridSingular_infoUsersAddresses",
        method: 'GET',
...
//                $element: the tr element.
        ...
        url: "https://proxy.b2argebilisim.com/SlimProxyBoot.php?url=pktempFillGridSingular_infoUsersCommunications",
        method: 'GET',
        locale: "'" + ($('#langCode').val() + '-' + $('#langCode').val().toUpperCase()) + "'",
        toggle: "table",
        width: "500",
