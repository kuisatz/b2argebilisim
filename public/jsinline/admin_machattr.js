$(document).ready(function () {
   ...
   $('#tt_tree_menu').tree({
       url: 'https://proxy.b2argebilisim.com/SlimProxyBoot.php?url=pkFillMachineToolDefinitionsAttributes_sysMachineToolDefinitionAttribute&pk=' + $("#pk").val()+ '&language_code='+$("#langCode").val(),
       method: 'get',
       animate: true,
       checkbox: true,
       cascadeCheck: false,
