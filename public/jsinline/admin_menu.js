...
$('#tt_tree_menu').tree({
//url: 'https://proxy.b2argebilisim.com/SlimProxyBoot.php?url=pkFillForAdminTree_leftnavigation&pk=' + $("#pk").val()+ '&role_id='+selectedData.selectedData.value+'&language_code='+$("#langCode").val()+'&menu_types_id='+menu_types_id,
method: 'get',
animate: true,
checkbox: true,
cascadeCheck: false,
                    ...
                    onItemClicked : function(target) {
                        ...
                        if(target.value>0){
                            ...
                            if(ddDataMenuTypes.selectedData.value>0) {
                                ...
                                $('#tt_tree_menu').tree({ 
                                    url: 'https://proxy.b2argebilisim.com/SlimProxyBoot.php?url=pkFillForAdminTree_leftnavigation&pk=' + $("#pk").val()+ '&role_id='+target.value+'&language_code='+$("#langCode").val()+'&menu_types_id='+menu_types_id,
                                });
                            } else {
